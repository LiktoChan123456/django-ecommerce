...
class Product(models.Model):
    ...
    pid = ShortUUIDField(unique=True, length=10, prefix="DIX", alphabet="abcdefg123456") 
    slug = models.SlugField(unique=True)
    date = models.DateTimeField(auto_now_add=True) #if want to show in admin : default = timezone.auto_add now
...
class Gallery(models.Model):
    ...
    active = models.BooleanField(default=True)
    gid = ShortUUIDField(unique=True, length=10, prefix="DIX", alphabet="abcdefg123456") 
...
class Specification(models.Model):
    ...
    #title Made in China, USA and Nigeria
    #item weight- 128kg...
