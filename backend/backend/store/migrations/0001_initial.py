# Generated by Django 4.2.13 on 2024-07-06 09:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefg123456', length=10, max_length=13, prefix='DIX', unique=True)),
                ('slug', models.SlugField(unique=True)),
