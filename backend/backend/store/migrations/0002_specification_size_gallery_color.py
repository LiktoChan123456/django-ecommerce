# Generated by Django 4.2.13 on 2024-07-06 11:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefg123456', length=10, max_length=13, prefix='DIX', unique=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.product')),
            ],
        ),
        migrations.CreateModel(
